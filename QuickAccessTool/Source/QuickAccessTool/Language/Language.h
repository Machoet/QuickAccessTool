...
namespace QuickAccessToolLanguage
{
	...
	static const FText DescHint = LOCTEXT("DescHint", "Enter command description");
	static const FText AddButton = LOCTEXT("AddButton", "Add Command");
	static const FText DeleteButton = LOCTEXT("DeleteButton", "Delete Selected");
	static const FText ClearButton = LOCTEXT("ClearButton", "Clear All");
	static const FText ExecuteButton = LOCTEXT("ExecuteButton", "Execute");
	static const FText ExecuteTooltip = LOCTEXT("ExecuteTooltip", "Click to execute this command");
	
	static const FText RunEditorUtilityWidget = LOCTEXT("RunEditorUtilityWidget", "Run Editor Utility Widget");
}


static TArray<FText> MenuTexts = {QuickAccessToolLanguage::QuickPanel, QuickAccessToolLanguage::Common, QuickAccessToolLanguage::CustomTask, QuickAccessToolLanguage::Command};
